...
Is this fan out?
YEs and No
Are we "fanning out" work? Yes. We've launced several goroutines that are simultaneously publishing a
...
"fanning in" though here. Remember how the golang blog describes fan in: "A function can read from multiple
inputs and proceed until all are closed by multiplexing the input channels onto a single
